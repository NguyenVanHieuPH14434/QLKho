        ...
        <div className='producer'>
            ...
            <Form>
                <Form.Group className="mb-3 fcontainer" controlId="exampleForm.ControlInput1">
                    ...
                    <Form.Control type="text" placeholder="Nhập tên nhà cung cấp" className="fip" />
            ...
            <Table striped bordered hover size='md'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <Button variant="primary" className="btn" onClick={handleShow2}>Sửa</Button>
                    ...
                    <Row>
                        <Col>
                            <Row>
                                ...
                                <Form.Control type="text" style={{ width: "90%", marginLeft: "3%" }} />
                            </Row>
                            <Row>
            ...
            <Modal size="lg" show={show2} onHide={handleClose2}>
                <Modal.Header closeButton>
                    <Modal.Title className="total">Sửa Thông Tin Nhà Cung Cấp</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col>
